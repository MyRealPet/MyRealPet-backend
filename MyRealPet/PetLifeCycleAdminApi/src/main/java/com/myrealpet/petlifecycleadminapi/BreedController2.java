package com.myrealpet.petlifecycleadminapi;

import com.myrealpet.petlifecycleclient.breed.client.BreadApiClient;
...
public class BreedController2 {

    private final BreedService breedService;
    private final BreadApiClient breadApiClient;

    @PostMapping
    public ResponseEntity<RegisterBreedResponse> register(@RequestBody RegisterBreedRequest request) {
        try {
            //ResponseEntity<RegisterBreedResponse> response = breadApiClient.register();
